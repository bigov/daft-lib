...
nk_glfw3_device_create(void)
{
    ...
    dev->attrib_uv = glGetAttribLocation(dev->prog, "NK_TexCoord");
...
NK_API void
nk_glfw3_mouse_button_callback(GLFWwindow* window, int button, int action, int)
{
    double x, y;
